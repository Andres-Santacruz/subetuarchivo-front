...
const SEO = {
  title: "Precios — Subetuarchivo ",
  description: "Conoce los precios para convertirte en un usuario premium en subetuarchivo y acceder a todas las funcionalidades",
  url: "/info/pricing",
  imgName: "home.png",
};
          ...
          <PriceWrapper>
            ...
            >
              <List spacing={3} textAlign="start" px={12}>
                ...
                <ListItem>
                  <ListIcon as={CheckCircle} color="green.500" />1 día de acceso
                  a tus archivos.
                </ListItem>
                <ListItem>
                  <ListIcon as={CheckCircle} color="green.500" />
