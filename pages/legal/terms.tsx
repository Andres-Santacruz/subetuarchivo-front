      ...
      >
        <VStack paddingTop="10px" spacing="2" alignItems="flex-start">
          ...
          <HStack align={"top"}>
            ...
            <VStack align={"start"}>
              <Text fontWeight={600}>Un servicio para compartir archivos.</Text>
            </VStack>
          </HStack>
          <HStack align={"top"}>
            <Box color={"green.400"} px={2}>
          ...
          <HStack align={"top"}>
            ...
            <VStack align={"start"}>
              <Text fontWeight={600}>
                Un servicio que le permite presentar sus ideas, características
          ...
          <Text as="p" fontSize="lg">
            ...
            aplicaciones móviles y/o de escritorio y/o se pueden integrar en un
          ...
          <Text as="p" fontSize="lg">
            ...
            usted. (juntos: “Contenido”). Usted conserva todos los derechos y la
            responsabilidad por todo el Contenido.
          </Text>
          <Text as="p" fontSize="lg">
            Al acceder y compartir archivos con Subetuarchivo, usted confirma
            que esta de acuerdo y sujeto a los términos de servicios contenidos
            en lo términos y condiciones que se describen a continuación. Estos
            términos se aplican a todo el sitio web y a cualquier correo
            electrónico u otro tipo de comunicación entre usted y Subetuarchivo.
          </Text>

          <Text as="p" fontSize="lg">
            En ninguna circunstancia el equipo de Subetuarchivo será responsable
            de ningún daño directo, indirecto, especial, incidental o
            consecuente, que incluye, entre otros, la perdida de datos o
            ganancias que surjan del uso o la incapacidad de usar, lo materiales
            de este sitio, incluso si el equipo de Subetuarchivo o un
            representante autorizado han sido informado de la posibilidad de
            tales daños.
          </Text>
          <Text as="p" fontSize="lg">
          ...
          <VStack paddingTop="20px" spacing="2" alignItems="flex-start">
            ...
            <Text as="p" fontSize="lg">
              ...
              &quot;nuestro&quot;), el proveedor del sitio web de Subetuarchivo
              y los servicios accesibles desde el sitio web de Subetuarchivo
              (que se denominan colectivamente en estos Términos y condiciones
              como el &quot;Servicio de Subetuarchivo&quot;).
            </Text>
            <Text as="p" fontSize="lg">
              ...
              la entidad que representa. Si viola cualquiera de estos Términos y
              condiciones, nos reservamos el derecho de cancelar su cuenta o
          ...
          <VStack paddingTop="20px" spacing="2" alignItems="flex-start">
            ...
            <Text as="p" fontSize="lg">
              ...
              web y guardados por su navegador web. Se utiliza para identificar
            ...
            <Text as="p" fontSize="lg">
              ...
              &quot;nuestro&quot;, se refiere a Subetuarchivo que es responsable
              de su información en virtud de estos Términos y Condiciones.
            </Text>
            <Text as="p" fontSize="lg">
            ...
            <Text as="p" fontSize="lg">
              ...
              como un teléfono, tablet, computadora o cualquier otro dispositivo
              que se pueda usar para visitar Subetuarchivo y usar los servicios.
            </Text>
            <Text as="p" fontSize="lg">
              <b>Servicio:</b> se refiere al servicio brindado por Subetuarchivo
              como se describe en los términos relativos (si están disponibles)
          ...
          <VStack paddingTop="20px" spacing="2" alignItems="flex-start">
            ...
            <Text as="p" fontSize="lg">
              ...
              rendimiento y la funcionalidad de nuestra plataforma, pero no son
              esenciales para su uso. Sin embargo, sin estas cookies, es posible
              que ciertas funciones, como los videos, no estén disponibles o se
              le solicitará que ingrese sus datos de inicio de sesión cada vez
              que visite la plataforma, ya que no podríamos recordar que había
          ...
          <VStack paddingTop="20px" spacing="2" alignItems="flex-start">
            ...
            <Text as="p" fontSize="lg">
              Usted reconoce y acepta que Subetuarchivo puede dejar de brindarle
              (de forma permanente o temporal) el Servicio (o cualquier función
              dentro del Servicio) a usted o a los usuarios en general, a
              discreción exclusiva de Subetuarchivo, sin previo aviso. Puede
              dejar de utilizar el Servicio en cualquier momento. No es
              necesario que informe específicamente a Subetuarchivo cuando deje
              de usar el Servicio. Usted reconoce y acepta que, si Subetuarchivo
              deshabilita el acceso a su cuenta, es posible que no pueda acceder
              al Servicio, los detalles de su cuenta o cualquier archivo u otro
              material contenido en su cuenta.
            </Text>
            <Text as="p" fontSize="lg">
          ...
          <VStack paddingTop="20px" spacing="2" alignItems="flex-start">
            ...
            <Text as="p" fontSize="lg">
              ...
              interrumpir, temporal o permanentemente, la plataforma o cualquier
              servicio al que se conecte, con o sin previo aviso y sin
              responsabilidad ante usted.
            </Text>
          </VStack>
          ...
          <VStack paddingTop="20px" spacing="2" alignItems="flex-start">
            ...
            <Text as="p" fontSize="lg">
              Subetuarchivo puede, de vez en cuando, proporcionar mejoras a las
            ...
            <Text as="p" fontSize="lg">
              ...
              habilitando características y / o funcionalidades particulares de
              la plataforma.
            </Text>
            <Text as="p" fontSize="lg">
          ...
          <VStack paddingTop="20px" spacing="2" alignItems="flex-start">
            <Heading as="h2">Aviso de infracción de derechos de autor</Heading>
            <Text as="p" fontSize="lg">
              ...
              propietarios de los derechos de autor; y € la declaración de que
          ...
          <VStack paddingTop="20px" spacing="2" alignItems="flex-start">
            ...
            <Text as="p" fontSize="lg">
              ...
              disposición de los mismos), son propiedad de Subetuarchivo, sus
              licenciantes u otros proveedores de dicho material y están
              protegidos por Colombia y leyes internacionales de derechos de
              autor, marcas registradas, patentes, secretos comerciales y otras
              leyes de propiedad intelectual o derechos de propiedad. El
              material no puede ser copiado, modificado, reproducido, descargado
              o distribuido de ninguna manera, en su totalidad o en parte, sin
              el permiso previo expreso por escrito de Subetuarchivo, a menos
              que y excepto que se indique expresamente en estos Términos y
              Condiciones. Se prohíbe cualquier uso no autorizado del material.
            </Text>
          </VStack>
        </VStack>
      </Stack>
