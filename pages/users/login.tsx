...
import OwnHead, { IPropsOwnHead } from "../../components/OwnHead";

type ITag = "email" | "password";

const SEO: IPropsOwnHead = {
  title: "Inicia sesión — Subetuarchivo ",
  description:
    "Inicia sesión en subetuarchivo para disfrutar de configuraciones avanzadas y acceder a tus archivos",
  url: "/users/login",
  imgName: "home.png",
};
