...
const SEO = {
  title: "Tu(s) archivo(s) — Subetuarchivo ",
  description:
    "Acceso a tu archivo cuando quieras y compartelo con cualquier persona",
  url: "/file/U2FsdGVkX1+aEdYmxmqeVgxc6xIXFtlJqrpbjde7CV8=",
  imgName: "home.png",
};
...
const ReadFilePage = ({ data, code, status }: Prop) => {
  ...
  if (status === "expired") {
    return (
      <>
        <OwnHead
          title="Archivo vencido — Subetuarchivo"
          description={SEO.description}
          imgName={SEO.imgName}
          url={SEO.url}
        />
  ...
  if (status === "protected") {
    return (
      <>
        <OwnHead
          title="Archivo protegido — Subetuarchivo"
          description={SEO.description}
          imgName={SEO.imgName}
          url={SEO.url}
        />
  ...
  if (FILES.length === 0 || status === "notFound") {
    return (
      <>
        <OwnHead
          title="Archivo no encontrado — Subetuarchivo"
          description={SEO.description}
          imgName={SEO.imgName}
          url={SEO.url}
        />
        <Box bg={"gray.50"} backgroundColor="transparent" width="100%" mt={8}>
          ...
          >
            ...
            >
              <Text fontSize="lg">
                No se encontró ningun archivo archivo 😞
              </Text>
